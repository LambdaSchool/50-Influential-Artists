...
/*function fixTypo() {
  if(Array.prototype.indexOf() === 9) {
    artists[9].name = artists.name: 'Vincent Van Gogh'
  };
}
...
const obj = {
id: 21,
name: 'G. Damon Moullet',
years: '1975 - 2020',
genre: 'Graphic Designer, Artist, Web Designer',
nationality: 'American',
bio: 'A gritty, raw, in your face style influenced by a life spent in the streets and ghetto. '};


function addArtist(obj, artists){
  ...
  const finalArray = artists.concat(objectArray);
  return finalArray;
  }
