...
function lotsOfArt(array,index){
  for(let i = 0; i <= array[index].paintings-1; i++){
    if(array[index].paintings >= "100"){
     return `The artist ${array[index].name} made ${array[index].paintings} pantings!`;
    }
    else{return `The artist ${array[index].name} made ${array[index].paintings} pantings. so little...`;
    }
  }
    /* Code here */
  ...
  console.log(lotsOfArt(artists, 1));
