...
Preprocessing can take information from multiple sources and compile it into one source, and it uses multiple functions in order to keep your code dry.  It allows you to change multiple items in your code by only changing one item.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

my favorite concept is ease in which you can change multiple things at once.  I cannot pinpoint any particular aspect that causes me trouble.

3. How would you explain the concept of a variable to someone new to programming?

a variable is used to store information to be referenced and manipulated in a computer program. They also provide a way of labeling data with a descriptive name, so our programs can be understood more clearly by the reader and ourselves.

4. What is the purpose of using functions in code?

to compartmentalize items in code, to control execution
