...
1. How would you describe preprocessing to someone new to CSS?
    ...
    Prepreocessing CSS is a type of program that lets you generate from a preprocessor's syntax to add new features, nesting and mixins. 

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

     My favorite concept in preprocessing is nesting it helps withorganization of the style sheet. The concept that I also have the most trouble with are mixins, I understand how to use them, just not 100% when to use them. 
...
4. What is the purpose of using functions in code?
    ...
    there used to preform a particular task, and they are used to aciod repetition of commands
