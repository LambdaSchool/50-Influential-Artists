...
1. How would you describe preprocessing to someone new to CSS? Allows you to reuse the same elements in CSS and increase productivity in your code
2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble? Favorite concept are mixins. Hardest concept is using parametric functions with flexbox
3. How would you explain the concept of a variable to someone new to programming? Holds a peice of data in one word
4. What is the purpose of using functions in code? To re-use data anywhere in your code
5. What is a JSON data? Server data that can convert into Javascript objects. 
